...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        with(holder) {
            imgDog?.setImageResource(item.imageResourceId)
            tvName?.text = item.name
            tvAge?.text = resources?.getString(R.string.dog_age, item.age.toString())
            tvHobbies?.text = resources?.getString(R.string.dog_hobbies, item.hobbies)
        }
